...
const SERVICE_NAME = "Handmade Beauty Products";
const LOCATION = "Andhra Pradesh";
const SLUG = "handmade-beauty-products-andhra-pradesh";

const seo = getSeoData('/handmade-beauty-products-andhra-pradesh');
